...
The project **connector-groovy-test** is a Bonita Connector for **Bonita {short-bonita-version}**  **Community** version written in `groovy` language.
...
[source,bash]
----
git clone https://your.github.com/connector-groovy-test.git
cd connector-groovy-test/
mvn package
----

The build should produce a zip archive under the `target/` folder named `connector-groovy-test-1.0.0-all.zip`
...
Take the built artifact `connector-groovy-test-1.0.0-all.zip` and import it to your Bonita Studio.
