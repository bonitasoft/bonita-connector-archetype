...
The project **connector-kotlin-test** is a Bonita Connector for **Bonita {short-bonita-version}**  **Community** version written in `kotlin` language.
...
[source,bash]
----
git clone https://your.github.com/connector-kotlin-test.git
cd connector-kotlin-test/
mvn package
----

The build should produce a zip archive under the `target/` folder named `connector-kotlin-test-1.0.0-all.zip`
...
Take the built artifact `connector-kotlin-test-1.0.0-all.zip` and import it to your Bonita Studio.
